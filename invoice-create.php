			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					<div class="row">
						...
						<div class="col-xs-3">
							Rp.<span class="invoice-sub-total">0.00</span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							Rp.<span class="invoice-discount">0.00</span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							Rp.<span class="invoice-vat" data-enable-vat="<?php echo ENABLE_VAT ?>" data-vat-rate="<?php echo VAT_RATE ?>" data-vat-method="<?php echo VAT_INCLUDED ?>">0.00</span>
					...
					<div class="row">
						...
						<div class="col-xs-3">
							Rp.<span class="invoice-total">0.00</span>
