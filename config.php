...
define('DATABASE_NAME', 'u1599779_app_mega');
define('DATABASE_USER', 'u1599779_app_mega');
define('DATABASE_PASS', '!JoyfulJoyfulLord%0722');

// COMPANY INFORMATION
define('COMPANY_LOGO', '/images/logo.png');
define('COMPANY_LOGO_WIDTH', '300');
define('COMPANY_LOGO_HEIGHT', '90');
define('COMPANY_NAME','Brillantez Solutions');
