...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span style="text-decoration:none;" class="logo-lg"><b>Brillantez</b>Invoice System</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <!-- Menu 1 -->
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <?php
            if((isset($_SESSION['login_username']) == "FinanceController")){
            ?>
        ...
        <!-- Menu 4 -->
        <li class="treeview">
          <a href="about.php"><i class="fa fa-user"></i><span>About Us</span>
        </li>
